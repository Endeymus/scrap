 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.endeymus.scrap.spring.ch12.repository"})
@ComponentScan(basePackages = {"com.endeymus.scrap.spring.ch12"})
public class DataServiceConfig {
    ...
    public EntityManagerFactory entityManagerFactory() {
        ...
        factoryBean.setPackagesToScan("com.endeymus.scrap.spring.ch12.entities");
